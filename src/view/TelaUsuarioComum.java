...
public class TelaUsuarioComum extends JFrame {
	...
	public TelaUsuarioComum() {
		...
		tabbedPane.addTab("Cadastro e Participa��o", null, panelCadastro, null);
		...
		tabbedPane.addTab("Visualiza��es", null, panelVisualizacao, null);
		
		JPanel panelAtas = new JPanel();
		tabbedPane.addTab("Atas", null, panelAtas, null);
		
		JPanel panelPlanoDeAcao = new JPanel();
		tabbedPane.addTab("Plano de A��o", null, panelPlanoDeAcao, null);
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(senha.equals(confirmarSenha)) {
				//Entrar com a verifica��o de usuario
				usuario.toString();
				//usuario.cadastrarUsuario(conect, ps, rt, nome, cpf, senha);
				lblCadastroConfirmacao.setText("Cadastro feito com sucesso!");
			}else {
				// Messagem dizendo que as senhas n�o sao iguais!
				System.out.println("As senhas n�o estao corretas");
			}
		}
	}
